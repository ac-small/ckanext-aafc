...
git clone -b v2_9 https://github.com/aafc-ckan/ckanext-aafc && pushd ckanext-aafc && python setup.py develop && popd
git clone -b v2_9 https://github.com/aafc-ckan/ckanext-scheming.git && pushd ckanext-scheming && python setup.py develop && popd

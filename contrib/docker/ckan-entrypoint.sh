...
set_environment () {
  ...
  export CKAN__LOCALES_OFFERED="${CKAN__LOCALES_OFFERED}"
  ...
  export CKAN__VIEWS__DEFAULT_VIEWS=${CKAN__VIEWS__DEFAULT_VIEWS}
  export CKAN___CKANEXT__GEOVIEW__OL_VIEWER__FORMATS=${CKAN___CKANEXT__GEOVIEW__OL_VIEWER__FORMATS}
  export CKAN__ROOT_PATH=${CKAN__ROOT_PATH}
  }
